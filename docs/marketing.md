...
| 6 | Japan Financial Statements (EDINET Official) | japan-edinet-financials | Japan Financial Statements API — BS, P&L & Cash Flow in English (EDINET) |
| 7 | Japan Business Days & Calendar (Cabinet Office Official) | japan-business-days-calendar | Japan Business Days & Holidays API — Wareki (Japanese Era) Conversion |
...
| 5 | Japanese law API: full text of Japanese laws as structured JSON with English reference translations and summaries. Official e-Gov data, point-in-time versions. | japan, laws, legal-data, e-gov, translation, official-api | Business（無ければDeveloper tools） |
| 6 | Japan financial statements API in English. Normalized balance sheet, income statement & cash flow of Japanese listed companies from official EDINET annual reports. JSON output, no scraping. | japan, edinet, financial-statements, balance-sheet, fundamentals, official-api（公開時の現行タグ体系で確定） | Finance／Business |
| 7 | Japan business days API. Check, add & count business days with Japanese national holidays & custom closures. Wareki era conversion both ways. Official Cabinet Office data, JSON. | japan, business-days, holidays, calendar, wareki, japanese-era, official-api（公開時の現行タグ体系で確定） | Developer tools（無ければAutomation／Business） |
...
- #6: japan financial statements / japanese company financials api / edinet xbrl english / japan balance sheet data / japan fundamentals api
- #7: japan business days api / japanese holidays api / wareki conversion / japanese era date / japan calendar api / business day calculator japan
