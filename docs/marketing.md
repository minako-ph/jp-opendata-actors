...
- SEO description（Google・「冷たい」訪問者向け）: 検索語のバリエーションを含める（例 #1: "EDINET API in English. Structured annual & semi-annual filings of Japanese listed companies: revenue, income, employees. Official FSA data, JSON output."）。
